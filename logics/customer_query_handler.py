...
def generate_response_based_on_course_details(user_message, product_details):
    ...
    Make sure to include {delimiter} to separate every step. Do not include {delimiter} after the last step. 
    """

    # In the prompts, need to be careful of the prompt result returning delimiters. 
    messages =  [
        {'role':'system',
         'content': system_message},
        {'role':'user',
